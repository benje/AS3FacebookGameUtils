 ...
 * 	Dependencies: GraphAPI_Web_1_8_1.swc, team2p0.Preload, Greensock TweenLite, Signals
 *
 **/
...
//	import flash.external.ExternalInterface;
	...
	public class FacebookGameUtils extends EventDispatcher
	{
		// constants
		public static const API_KEY           	  : String = "XXXXXXXXXXXXXX";
		//public static const PERMISSIONS        	  : String = "read_stream,publish_stream,user_likes,user_about_me,read_friendlists";
		public static const PERMISSIONS		      : Object = {scope:"publish_stream, user_photos, user_status, friends_status,friends_photos"};
		public static const FB_REDIRECT_URL       : String = "http://apps.facebook.com/XXXXXXXXXXX/";
		...
		public function FacebookGameUtils()	
		{
...
//			Security.allowInsecureDomain("*");
		...
		private function handleFacebookRequest(requestType:String):void
		{
			...
			{
				case REQ_MYDETAILS:
					Facebook.api("/me",handleDetailsLoad);
		...
		private function retrieveProfilePhotoURLs(userIds:Array):Array
		{
			...
			for each (var userId:Object in userIds){
				imgURL = Facebook.getImageUrl(String(userId), 'large');
...
//				ExternalInterface.call("redirect", API_KEY, "publish_stream, user_photos, user_status, friends_status,friends_photos", FB_REDIRECT_URL);
		...
		private function logoutHandler(response:Object):void
		{
			...
			_loggedState = (topURL) ? FacebookGameUtils.LOGGED_OUT : FacebookGameUtils.LOGGED_OUT_ON_FB;
		}
